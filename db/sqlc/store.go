...
// TransferTx performs a money tranfer from one account to the other.
// It create a transfer record, add ccount entries, and update accountts' balance within a single database transaction
